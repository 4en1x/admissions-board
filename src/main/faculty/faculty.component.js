    ...
    render() {
        ...
        return (
            <div>
                ...
                <List>
                    {
                        this.state.faculty.subjects.map(subject => {
    ...
    
                {
                    this.props.role === roles.ADMIN.ROLE ? (
                        <List.Content floated='right'>
                            <Icon onClick={() => this.props.onEditPageClick(this.state.faculty.id)} name="edit" size="large" color="green"/>
                            <Icon onClick={() => this.props.onDeleteElementClick(this.state.faculty.id)} name="delete" size="large" color="red"/>
                        </List.Content>
                    ) : null
                }
